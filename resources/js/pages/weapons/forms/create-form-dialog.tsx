...
import { WeaponStatusOptions, WeaponConditionOptions, PermitTypeOptions } from '../types';
...
export const CreateWeaponForm = () => {
    ...
    const handleSubmit = (values: z.infer<typeof weaponSchema>) => {
        router.post(weapons.store().url, values, {
            preserveState: true,
            replace: true,
            only: ['data'],
            onProgress: () => {
            ...
            onSuccess: () => {
                ...
                toast.success('Berhasil menambahkan senjata baru');
            },
            onError: () => {
                toast.error('Gagal menambahkan senjata baru');
            },
            onFinish: () => {
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <Form {...form}>
                ...
                <DialogContent className="max-h-[90vh] overflow-y-auto max-w-2xl" aria-describedby="weapon-form">
                    <DialogHeader>
                        <DialogTitle>Tambah Senjata</DialogTitle>
                        <DialogDescription>
                            Isi data senjata baru pada form di bawah ini.
                        </DialogDescription>
                    </DialogHeader>
